...
GD-1 members are visible as the over-density around $(\mu_{\phi_1, \odot},
...
over-density of stars around $\phi_2 = 0$ between longitudes $-60^\circ \lesssim
...
The central panel of Figure~\ref{fig:features} shows the map of GD-1, with fields of interest marked in shades of purple for spur-related fields, and shades of blue for blob-related fields.
