...
significant density variations along the stream, and (4) indicates
...
The complex morphology of the stream points to a turbulent history; the detailed morphology in phase space of the perturbed stream members could potentially provide constraints on dark matter substructure that might have interacted with the stream.
