...
As a first selection of GD-1 member stars, we choose stars \changes{that lie in the orange polygon in proper motions (top right panel of \figurename~\ref{fig:selection}; approximately bounded by the rectangle
