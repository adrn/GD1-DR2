...
\figurename~\ref{fig:XX} (top right) shows the distribution of stars with
...
\figurename~\ref{fig:XX}.
\figurename~\ref{fig:XX} (top left) shows all stars the pass the selection on
proper motion, plotted in the GD-1 coordinate system.
...
clean the sample.
\figurename~\ref{fig:XX} (bottom right) shows the distribution of
