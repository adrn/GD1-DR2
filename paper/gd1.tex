...
These discoveries were only possible because the exquisite proper motions from \gaia\ permit a clean separation of the stream from the Milky Way stars.
The additional length and proper treatment of the progenitor will aid in dynamical modeling of GD-1 and map the Galaxy on large scales.
The complex morphology of the stream points to a turbulent history; the detailed phase-space of the perturbed stream members could potentially constrain dark matter substructure in the Milky Way.
